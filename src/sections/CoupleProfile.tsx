      ...
      <div className="relative z-10 w-full max-w-2xl mx-auto">
        ...
        >
          ...
          <motion.div variants={staggerItem} className="flex flex-col sm:flex-row items-center gap-6 sm:gap-10 text-center sm:text-left">
            <div className="relative w-40 h-40 sm:w-48 sm:h-48 rounded-full border-4 border-[var(--color-emerald)]/10 p-2 shrink-0">
              <div className="w-full h-full rounded-full overflow-hidden relative bg-gray-100 shadow-md">
                {/* Fallback pattern since we don't have actual groom photo */}
                <div className="absolute inset-0 flex items-center justify-center text-4xl font-heading text-[var(--color-emerald)]/50 bg-gradient-to-br from-emerald-50 to-white">
                  A
                </div>
              </div>
              <div className="absolute -bottom-2 -right-2 w-12 h-12 bg-white rounded-full border border-[var(--color-emerald)]/20 flex items-center justify-center shadow-sm text-lg">
                👨🏻
              </div>
            </div>
            ...
            <div>
              ...
              <a href="#" className="inline-flex items-center gap-2 text-sm text-[var(--color-emerald)] hover:text-[var(--color-emerald-dark)] font-medium transition-colors">
          ...
          <motion.div variants={staggerItem} className="flex flex-col sm:flex-row-reverse items-center gap-6 sm:gap-10 text-center sm:text-right">
            <div className="relative w-40 h-40 sm:w-48 sm:h-48 rounded-full border-4 border-[var(--color-emerald)]/10 p-2 shrink-0">
              <div className="w-full h-full rounded-full overflow-hidden relative bg-gray-100 shadow-md">
                {/* Fallback pattern since we don't have actual bride photo */}
                <div className="absolute inset-0 flex items-center justify-center text-4xl font-heading text-[var(--color-emerald)]/50 bg-gradient-to-bl from-emerald-50 to-white">
                  N
                </div>
              </div>
              <div className="absolute -bottom-2 -left-2 w-12 h-12 bg-white rounded-full border border-[var(--color-emerald)]/20 flex items-center justify-center shadow-sm text-lg">
                🧕🏻
              </div>
            </div>
            ...
            <div>
              ...
              <a href="#" className="inline-flex items-center justify-end gap-2 text-sm text-[var(--color-emerald)] hover:text-[var(--color-emerald-dark)] font-medium transition-colors">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                  <rect x="2" y="2" width="20" height="20" rx="5" ry="5"/>
                  <path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/>
                  <line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/>
